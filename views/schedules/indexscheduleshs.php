<div class="container">
	<div class="row ml-3">
		<h4><span class="badge badge-primary">Edit Schedule</span></h4>
	</div>
	<div class="col-md-6">
       <form action="<?php echo ROOT_URL;?>schedules/indexscheduleshs" method="post" id="setadviser">
			...
			<div class="card sched-card">
				...
				<h4 class="text-center">G<?php echo $result['grade'].' '.$result['section']; ?></h4>
					...
					<div class="card-footer">
						<a href="<?php echo ROOT_URL; ?>schedules/createscheduleshs/<?php echo $result['trn']; ?>">

						<button class="btn btn-primary" name="view" value="view">Edit</button>
						</a>
