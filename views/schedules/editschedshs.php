...
<div class="row mb-2 mt-4">
	...
	<table class="table table-sm">
	  ...
	  <tbody>
	    ...
	    <tr>
	    <td><input type="checkbox" name="selected[]" form="addsched" value="<?php echo  $sched_data['schedid']; ?>"></td>
	      <td><?php echo $sched_data['subjectcode']; ?></td>
	      <td><?php echo $sched_data['description']; ?></td>
	      <td class=""><?php if($sched_data['mon'] == '1'){
	      	echo '<i class="fa fa-check" ></i>';
	      }	else { echo '<i class="fa fa-times"; ></i>'; } ?></td>
	      <td class=""><?php if($sched_data['tue'] == '1'){
	      	echo '<i class="fa fa-check" ></i>';
	      }	else { echo '<i class="fa fa-times"; ></i>'; } ?></td>
	      <td class=""><?php if($sched_data['wed'] == '1'){
	      	echo '<i class="fa fa-check" ></i>';
	      }	else { echo '<i class="fa fa-times"; ></i>'; } ?></td>
	      <td class=""><?php if($sched_data['thu'] == '1'){
	      	echo '<i class="fa fa-check" ></i>';
	      }	else { echo '<i class="fa fa-times"; ></i>'; }
	       ?></td>
	      <td class=""><?php if($sched_data['fri'] == '1'){
	      	echo '<i class="fa fa-check" ></i>';
	      }	else { echo '<i class="fa fa-times"; ></i>'; } ?></td>
