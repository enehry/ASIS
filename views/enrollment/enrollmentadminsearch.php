...
<?php Messages::displayCustomMsg() ?>
  ...
  <div class="row">
    <div class="col-md-6">
       <form action="<?php echo ROOT_URL;?>enrollment/enrollmentadminsearch" method="post" id="enrollmentadmin">
        <div class="input-group mb-3">
        <input type="text" class="form-control" value="<?php echo $_GET['id']; ?>"  name="searchitem">
  ...
  $pagination->paginate(ROOT_URL.'enrollment/enrollmentadminsearch/');
